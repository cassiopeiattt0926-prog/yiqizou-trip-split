const C='haoyouji-v20';
const ASSETS=['./','index.html','style.css?v=20','avatars.js?v=20','app.js?v=20','manifest.webmanifest','assets/brand/tt-transfer.svg','assets/brand/app-icon-180.png','assets/brand/app-icon-192.png','assets/brand/app-icon-512.png','assets/banners/multi-currency.jpg','assets/banners/participants.jpg','assets/banners/borrow.jpg','assets/banners/settlement.jpg','assets/banners/personal-stats.jpg'];
